package com.example.student.a3410873__mp_week13_1;
...
public class MainActivity extends Activity implements         MediaPlayer.OnPreparedListener,   //實作 MediaPlayer 的 3 個的事件監聽介面
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        uri = Uri.parse("android.resource://" + //預設會播放程式內的音樂檔
                getPackageName() + "/" + R.raw.m01);
        txvName.setText("m01.mp3");         //在畫面中顯示檔名
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == Activity.RESULT_OK) {
            ...
            uri = convertUri(data.getData());  //取得選取檔案的 Uri 並做 Uri 格式轉換
